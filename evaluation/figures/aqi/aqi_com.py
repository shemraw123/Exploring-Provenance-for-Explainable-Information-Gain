...
def perfArtemisWhynot():
    ...
    axwnq2=dfwnq2[['Naive','Our Approach']].plot.bar(width=0.7, color=['#00389F','#F43B00'])

    legend = axwnq2.legend(bbox_to_anchor=(-0.025, 1.036),prop={'size': 20},labels=['Naive','Our Approach'],loc=2,
...
def perfSingleDerWhynot():
    ...
    # axwnq2=dfwnq2[['100','1000','10000','FULL']].plot.bar(width=0.9)
    axwnq2=dfwnq2[['Naive','Our Approach']].plot.bar(width=0.7, color=['#E7D501','#F43B00'])
